...
static const char *fonts[]          = { "Terminus:pixelsize=24:antialias=true:autohint=true" };
static const char dmenufont[]       = "Terminus:pixelsize=24:antialias=true:autohint=true";
