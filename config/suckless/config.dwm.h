...
static const char *fonts[]          = { "xos4 Terminus:pixelsize=20:antialias=true:autohint=true" };
static const char dmenufont[]       = "xos4 Terminus:pixelsize=20:antialias=true:autohint=true";
